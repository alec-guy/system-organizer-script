...
/* package system-organizer-script-0.1.0.0 */
#ifndef VERSION_system_organizer_script
#define VERSION_system_organizer_script "0.1.0.0"
#endif /* VERSION_system_organizer_script */
#ifndef MIN_VERSION_system_organizer_script
#define MIN_VERSION_system_organizer_script(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_system_organizer_script */
...
#define CURRENT_COMPONENT_ID "system-organizer-script-0.1.0.0-inplace-system-organizer-script"
